...
# 3. Подготовить датасет (поместите ваши 30k изображений в dataset/raw/)
...
# 4. (Опционально) Применить аугментацию
...
Pull requests приветствуются! Для значительных изменений откройте issue для обсуждения.

## ⚠️ Важные замечания

**ВНИМАНИЕ**: Эта система предназначена только для **информационных и исследовательских целей**. Не используйте её для автономного управления транспортным средством. Всегда требуется контроль водителя.

- Система должна использоваться только как **advisory system**
- Не заменяет внимание водителя
- Тестируйте в безопасных условиях перед использованием на дороге
...
Сделано с ❤️ для безопасности дорожного движения
